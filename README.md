...
- V2: React, TypeScript, and Vite. Discover is now implemented with four illustrative restaurants, URL-backed search and filters, and responsive layouts. Restaurant Detail and Reservation are later phases.
...
Restaurant links currently lead to a deliberate "detail coming soon" state. The restaurant descriptions, service notes, price indications, and dietary information are illustrative portfolio data, not live availability claims.
